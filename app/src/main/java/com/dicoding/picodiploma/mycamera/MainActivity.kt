...
class MainActivity : AppCompatActivity() {
    ...
    private val trashList = listOf(
        TrashItem(1, "Plastic Bottle", "https://example.com/bottle.jpg"),
        TrashItem(2, "Paper", "https://example.com/paper.jpg"),
    ...
    private fun showItems(trashItem: TrashItem) {
